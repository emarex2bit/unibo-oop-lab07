...
public final class Transformers {
    ...
    public static <I> List<? extends I> flatten(final Iterable<? extends Collection<? extends I>> base) {
        final ArrayList<I> l = new ArrayList<>();
        for (final Collection<? extends I> collection : Objects.requireNonNull(base, "The base iterable cannot be null")) {
            l.addAll(collection);
        }
        return l;
    }
    ...
    public static <I> List<I> select(final Iterable<I> base, final Function<I, Boolean> test) {
        ...
        for (I i : Objects.requireNonNull(base, "The base iterable cannot be null")) {
            if(test.call(i)) l.add(i);
        }
        return l;
    }
